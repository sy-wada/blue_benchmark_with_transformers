...
"""
Finetuning your BERT models for sequence classification(multi_label).
...
from processors.models import BertForMultiLabelSequenceClassification

from processors.utils_blue import convert_multi_label_examples_to_features as convert_examples_to_features
...
from metrics.hoc import eval_hoc, eval_roc_auc
